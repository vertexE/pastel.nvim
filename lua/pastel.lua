...
M.colorscheme = function()
	...
	vim.api.nvim_set_hl(0, "MiniIconsGreen", { fg = sage:saturate():darken(11):hex() })
	...
	vim.api.nvim_set_hl(0, "PmenuSel", { bg = chalk:hex(), bold = true })
	vim.api.nvim_set_hl(0, "PmenuKind", { fg = stone_100:hex(), bold = true })
	...
	vim.api.nvim_set_hl(0, "Keyword", { fg = rose:darken(11):hex() })
	vim.api.nvim_set_hl(0, "Comment", { italic = true, fg = stone_200:darken(11):hex() })

	-- lsp warnings
	vim.api.nvim_set_hl(0, "DiagnosticUnnecessary", { fg = chalk:darken(15):hex() })
	vim.api.nvim_set_hl(0, "DiagnosticError", { fg = rose:hex() })
	vim.api.nvim_set_hl(0, "DiagnosticHint", { fg = gold:darken(22):hex() })
	vim.api.nvim_set_hl(0, "DiagnosticWarn", { fg = peach:hex() })
	vim.api.nvim_set_hl(0, "DiagnosticInfo", { fg = gold:darken(22):hex() })
	...
	vim.api.nvim_set_hl(0, "@function", { fg = rose:darken(11):hex(), italic = true })
